...
const MainHome = () => {
    return (
        <Container className="main-home">
            <Box className='bg-white py-2 my-3 rounded-3 d-flex flex-column'>
                <Box className='post-text-field w-75 rounded-pill p-1 mx-auto mb-2'>
                    <Avatar
                        alt="semy Sharp"
                        src="/static/images/avatar/1.jpg"
                        sx={{ width: 60, height: 60, bgcolor: "#8A61CE", fontSize: '20px'}}
                    />
                ...
                <Box sx={{ mx: 'auto' }} className='d-flex justify-content-around w-75'>
                    ...
                    <Button color="secondary" variant="contained" sx={{px: 3}} size="small" startIcon={<EmojiEmotionsIcon />} className="font fs-6">Felling</Button>
                </Box>
            </Box>
